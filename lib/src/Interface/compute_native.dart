...
class _IsolatePool {
  ...
  final Map<int, int> _taskCount = {}; // track the number of tasks processed by each isolate
  final Map<int, double> _avgTaskTime = {}; // track the average task execution time for each isolate
