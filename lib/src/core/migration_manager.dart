...
class MigrationManager {
  ...
  Future<MigrationTask?> addMigrationTask(
    ...
    if (targetSchema != null) {
      targetSchema = targetSchema.cleanInternalFields();
      targetSchema = targetSchema.copyWith(
        tableUid: tableUid,
        schemaVersion: GlobalIdGenerator.generate("s"),
        isSystemTable: SystemTable.isSystemTable(targetSchema.name),
      );
      targetSchema = targetSchema.generateAutoIndexes(oldSchema: oldSchema);
    }
