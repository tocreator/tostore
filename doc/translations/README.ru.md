...
### Хранилище ключей и значений (KV)
...
### Режим структурированной таблицы
...
## Интеграция для мобильных устройств, настольных компьютеров и других сценариев частого запуска
...
## Интеграция на стороне сервера/агента (длительные сценарии)
...
### Векторные поля, векторные индексы и векторный поиск
...
<a id="ttl-config"></a>
### TTL на уровне таблицы (автоматический срок действия на основе времени)
...
### Агрегация, группировка и статистика (Agg & GroupBy)
...
#### 4. Сложная логика с `QueryCondition`
...
<a id="query-cache"></a>
### Кэширование результатов запроса вручную (необязательно)
...
### Запрос и эффективная нумерация страниц
...
<a id="foreign-keys"></a>
### Внешние ключи и каскадирование
...
### Обратный вызов журнала и диагностика базы данных
...
## Объяснение расширенной конфигурации (DataStoreConfig)
