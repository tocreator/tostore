...
>
> 機密キーをハードコーディングしないでください。デバイスに紐づける場合は、`encryptionKey` を OS の Keychain / Keystore / セキュアエンクレーブに保存してからエンジンへ渡してください。
...
ハイライト — 100K スイートと 10 億規模エッジ実測（3 ラウンド、2026-08-29）：
...
詳細チャートと全項目: **[Benchmarks](../../BENCHMARKS.md)**。
