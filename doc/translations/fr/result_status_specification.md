...
| **23001** | `DEV_LARGE_SCALE_OPERATION_REQUIRED_BYPASS` | `ResultType.devLargeScaleOperationBypassRequired` | Erreur Développeur | L'opération à grande échelle nécessite d'omettre les détails pour éviter le OOM |
